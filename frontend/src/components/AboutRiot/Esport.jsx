import "../../assets/css/AboutRiot/Esport.css";

export default function Esport() {
  return (
    <div className="Esport-wiki">
      <section>
        <h1>L'Esport</h1>
        <hr />
        <br />
        <p>
          <img
            src="https://static.wikia.nocookie.net/lolesports_gamepedia_en/images/d/d5/2016_WCS_logo.png"
            alt="Cup Riot games"
          />
          ...
          pendant la finale. Par ailleurs, les équipes se sont vu offrir plus de
          ...
          même la finale de la NBA), ainsi que le jeu vidéo le plus regardé au
          monde. En raison de son succès, les scènes d'esports se sont imposées
          ...
          l'Asie du Sud-Est, les États-Unis et l'Europe ont déjà pu accueillir
          une compétition au moins une fois. À cause de la pandémie de COVID-19,
          l'édition 2020 n'a pu se faire que dans une seule ville, Shanghaï.
          Pour la première fois, la compétition a dû être organisée sans public,
          seule la finale ayant été ouverte au public. La Chine, l'Europe et les
          États-Unis ont pu accueillir la compétition trois fois chacun.
          <br />
          <br />
        </p>
