import "../../assets/css/AboutRiot/Enterprise.css";

export default function Enterprise() {
  return (
    <div className="Enterprise-wiki">
      <section>
        <h1>Riot Games</h1>
        <hr />
        <br />
      ...
      <section>
        ...
        <br />
        <p>
          Riot Games est fondé en 2006 par Brandon Beck (connu sous le
          pseudonyme de « Ryze ») et Marc Merrill (connu sous le pseudonyme «
          Tryndamere »).
        </p>
        <p>En 2009, Riot Games lance League of Legends.</p>
        <p>
        ...
        <p>
          ...
          droits de retransmission jusqu'en 2023 des Championnats du monde de
          League of Legends à Riot Games.
        </p>
        <p>
          Riot Games précise que cet accord concerne la distribution et la
          monétisation d'émissions de compétitions professionnelles pour le jeu
          vidéo League of Legends jusqu'en 2023 en contre-partie de 50 millions
          de dollars par an et un pourcentage des revenus publicitaires.
        </p>
        <p>
          Fin 2017, Beck et Merrill ont confié les activités quotidiennes et la
          gestion globale de l’équipe de League of Legends à trois employés de
          longue date. Dylan Jadeja, Scott Gelb et le français Nicolo Laurent
          sont désormais respectivement chef de la technologie (CTO), chef de
          l’exploitation (COO) et directeur général (CEO). En mai 2018, Riot
          Games employait 2 500 personnes et exploitait 24 bureaux dans le monde
          entier.
        </p>
        <p>
          Le 25 mai 2018, le contrat de 350 millions de dollars entre Riot Games
          et BAMTech annoncé en décembre 2016 est annulé au profit d'un contrat
          de diffusion de la League of Legends sur ESPN+ à partir de juin 2018.
        </p>
        <p>
